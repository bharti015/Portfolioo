  ...
  const certifications = [
    {
      ...
      year: "2023",
      description: "Comprehensive program covering data analysis processes, tools, and techniques used by data analysts.",
      icon: "fab fa-google",
    ...
    },
    {
      ...
      institution: "Coursera",
      year: "2023",
      description: "Advanced techniques in statistical analysis, machine learning, and predictive modeling.",
      icon: "fab fa-google",
    ...
    {
      title: "AI/ML for Geospatial Data",
      subtitle: "Specialized Training",
      institution: "IIRS",
      year: "2023",
      description: "Application of artificial intelligence and machine learning techniques to geospatial data analysis.",
      icon: "fas fa-satellite",
      color: "text-emerald-400 dark:text-purple-500",
      bgColor: "bg-emerald-100 dark:bg-gray-700",
      link: "https://drive.google.com/file/d/1Dz56faFzY5w08tkApwDp-1QcWRNhPRnr/view?usp=drive_link"
    }
  ];

  return (
    <section id="certifications" className="section-padding bg-dot-grid-light dark:bg-dot-grid-dark portfolio-bg-light portfolio-bg-dark">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-100 mb-4">Certifications</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {certifications.map((cert, index) => (
            <div key={index} className="theme-transition bg-white dark:bg-gray-800 rounded-xl p-6 hover:shadow-lg border border-gray-200 dark:border-gray-700">
              <div className="flex items-center mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">{cert.subtitle}</p>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-500 dark:text-gray-400">{cert.institution} • {cert.year}</span>
                <a 
                  href={cert.link}
