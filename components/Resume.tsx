...
export default function Resume() {
  const handleDownload = () => {
    ...
    link.download = 'Bharti_Resume.pdf';
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <div className="flex items-center">
              ...
              <div className="text-left">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Bharti_Resume.pdf</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Generated with LaTeX • Updated December 2023</p>
              </div>
            </div>
            <button 
